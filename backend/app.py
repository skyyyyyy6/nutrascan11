...
FD_CENTRAL_API_KEY = 'aBhxjWLdnCkVxsFPm4OauDWF56zsyuTAI59jgM0N'
...
def process_image(food_name):
    ...
    try:
        ...
        for food in search_results['foods']:
            ...
            relevant_nutrients = [
                'Calories', 'Energy', 'Protein', 'Carbohydrate, by difference', 'Total lipid (fat)',
...
def capture_endpoint():
    ...
    image_path = os.path.join(IMAGES_FOLDER, f'received_image_{int(time.time())}.jpeg')
